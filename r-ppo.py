...
class ActorNetwork(nn.Module):
    def __init__(self, input_dims, num_actions, hidden_dims=64):
        super().__init__()
...
class PPOAgent:
    def __init__(self, input_dims, num_actions):
        ...
        self.actor = ActorNetwork(self.input_dims, num_actions, self.hidden_size).to(device)
        self.critic = CriticNetwork(self.input_dims, num_actions, self.hidden_size).to(device)
